...
export default {
  ...
  cookies: {
    ...
    privacyPolicy: ['Пожалуйста, внимательно прочтите нашу', 'политику конфиденциальности,', 'чтобы иметь полное понимание того, как мы собираем, храним и используем персональные данные.']
  },
  footer: {
